				...
				React.DOM.div({className: "row clearfix"}, 
					React.DOM.div({className: "col-md-12 column"}, 
						React.DOM.div({className: "jumbotron"}, 
							React.DOM.h2(null, "MARC 21 to MODS 3-6 metadata transformer"), 
							      React.DOM.p(null, "This web service allows you to convert MARC21 records to the MODS format."),
							      React.DOM.hr(null), 
						...
						React.DOM.pre(null, "$ curl -d @input.marc21.xml -o output.mods.xml http://weblicht.sfs.uni-tuebingen.de/converter/Marc2MODS/rest"
						)
					)
				)
			)
			...
			React.DOM.div({className: "fileUploadBox"}, 
				React.DOM.div({className: "input-group"}, 
					React.DOM.span({style: specialAddon}, 
						"Upload your MARC21 metadata instance:"
					), 
...
var DownloadBox = React.createClass({displayName: 'DownloadBox',
	...
	render: function() {
		...
		var header = $.isEmptyObject(files) ? (React.DOM.span(null)) : (React.DOM.p(null, "Download generated MODS file: "));
